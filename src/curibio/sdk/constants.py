...
TIMEPOINT_BEGINNING_RECORDING_UUID = uuid.UUID("e41422b3-c903-48fd-9856-46ff56a6534c")
...
METADATA_UUID_DESCRIPTIONS = {
    ...
    TIMEPOINT_BEGINNING_RECORDING_UUID: "Timepoint of Beginning of Recording",
